...
bool CConn::getAudioFormat(uint8_t* sampleFormat, uint8_t* channels,
                           uint32_t* frequency)
{
  if (audioOutput == nullptr)
    return false;

  *sampleFormat = audioOutput->getSampleFormat();
  *channels = audioOutput->getChannels();
  *frequency = audioOutput->getFrequency();
